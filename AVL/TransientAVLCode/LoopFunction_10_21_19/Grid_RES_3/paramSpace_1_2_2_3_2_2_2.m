function [aeroForces] = paramSpace_1_2_2_3_2_2_2(sailStates,airStates)
	...
	Cm = (-13.950762)*sailStates.alpha + (-0.000000)*sailStates.beta + (8.316363)*sailStates.p + (-135.529190)*sailStates.q + (2.964742)*sailStates.r + (-0.068373)*sailStates.de;
