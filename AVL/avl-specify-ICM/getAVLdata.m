...
mass6 = info.mass6;
mass7 = info.mass7;
massT = info.massT;     % total sail structure
SM = info.SM;
xNP = info.xNP;
oldXNP = xNP;
yLyCM = info.yLyCM;
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%  Commented out block of plots  %%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%  in order to streamline for sim  %%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
[alfa, CL, errs, iters, xNP, de] = findStall_newclassic(design, 0);
