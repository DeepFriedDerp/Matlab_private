...
%% DERIVE TERMS FOR MOMENT OF INERTIA
I_CM_G = [
    Ixx Ixy Ixz
    Ixy Iyy Iyz
    Ixz Iyz Izz
...
I_CM_B = BcG * I_CM_G * GcB;

I_B_B = I_CM_B + mT * ((dot(rBCM_B , rBCM_B) * eye(3)) ...
...
% *************************** O_O_h_B_B ***********************************
O_O_h_B_B = transpose((I_B_B * transpose(O_omega_B_B))) + ...
...
subVect = [ ...
    ...
    ...
    ... % for moment of inertia
    0.7216 -0.1277 -0.0008 -0.3942 0.0014 1.1134 ...
    ...
    ...
    ... % lift,moment,and gravity force leftover vars, to make sure math works
    0 0 ...
    ...
    ...
    ... % some general constants
    37.5 0.1 75.6791544 1.991 -9.81 1.225...
    0.4 1.4 0.3 ...
    ...
    ... % lift and moment coefficients
    str2sym('CLa') str2sym('CLb') str2sym('CLde') str2sym('CLp') str2sym('CLq') str2sym('CLr') ...
