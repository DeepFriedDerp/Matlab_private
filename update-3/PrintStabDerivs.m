% PrintStabDerivs_revA(filename)
% Written by Christopher D. Yoder on 9/1/2017 to read avl output file of
% stability derivatives.
% Modified to print results to the cmd line for copy+paste to input file
clc

% file inputs
% filename = 'cm_calc_1.stabs';
% filename = fullfile('avl-runs', 'case-3', 'cm_calc_3.stabs');
filename = fullfile('avl-runs', 'case-3', 'case-3', 'cm_calc_3.stabs');
    ...
    if isempty(newLine) ~= 1      % if not blank
        ...
        switch newLine(1:6)         % get the first 6 characters
            ...
            case '  CXto'
                a = strsplit(newLine);      % split string by delimiter
                for i1 = 1:length(a)        % for all, find e and save it
                    if strcmp(cell2mat(a(i1)), 'CXtot') == 1
            ...
            case '  CYto'
                ...
                for i1 = 1:length(a)        % for all, find e and save it
                    ...
                    if strcmp(cell2mat(a(i1)), 'CYtot') == 1
                        % stabDerivs.Cmtot = str2double(cell2mat(a(i1 + 2)));
                        eval(['stabDerivs.', a{i1}, ' = ', a{i1 + 2}, ';']);
                        % break
                    end
            ...
            case '  CZto'
                ...
                for i1 = 1:length(a)        % for all, find e and save it
                    ...
                    if strcmp(cell2mat(a(i1)), 'CZtot') == 1
                        % stabDerivs.Cnptot = str2double(cell2mat(a(i1 + 5)));
                        eval(['stabDerivs.', a{i1}, ' = ', a{i1 + 2}, ';']);
                        % break
                    end
            ...
            case '  CDvi'
                ...
                for i1 = 1:length(a)        % for all, find e and save it
                    ...
                    if strcmp(cell2mat(a(i1)), 'CDind') == 1
                        % stabDerivs.CDvis = str2double(cell2mat(a(i1 + 2)));
                        eval(['stabDerivs.', a{i1}, ' = ', a{i1 + 2}, ';']);
                        % break
                    end
            ...
            case '  CLff'
                a = strsplit(newLine);      % split string by delimiter
                for i1 = 1:length(a)        % for all, find e and save it
                    if strcmp(cell2mat(a(i1)), 'CLff') == 1
                        % stabDerivs.CDvis = str2double(cell2mat(a(i1 + 2)));
                        eval(['stabDerivs.', a{i1}, ' = ', a{i1 + 2}, ';']);
                    end
                    if strcmp(cell2mat(a(i1)), 'CDff') == 1
                        % stabDerivs.CDvis = str2double(cell2mat(a(i1 + 2)));
                        eval(['stabDerivs.', a{i1}, ' = ', a{i1 + 2}, ';']);
                    end
                end 
...
% print to file
% clc
names = fieldnames(stabDerivs);
for i1 = 1:length(names)
    % print everything
    % fprintf('%s = %0.4f;\n', names{i1}, getfield(stabDerivs, names{i1}));
    
    % print only interesting things
    switch names{i1}
        case 'Sref'
        case 'Cref'
        case 'Bref'
        ...
        case 'Beta'
        case 'elev'
            printlast = sprintf('de = %0.4f;\n', getfield(stabDerivs, names{i1}));
        case 'Xnp'
        otherwise
            fprintf('%s = %0.4f;\n', names{i1}, getfield(stabDerivs, names{i1}));
    end
