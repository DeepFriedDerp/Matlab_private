classdef MadgwickAHRS_V2 < handle
...
%   28/09/2011    SOH Madgwick    Initial release
    ...
    properties (Access = public)
        SamplePeriod = 1/256;       % timestep between current measurement and next measurement
    ...
    methods (Access = public)
        function obj = MadgwickAHRS_V2(varargin)
            for i = 1:2:nargin
                if  strcmp(varargin{i}, 'Quaternion'), obj.Quaternion = varargin{i+1};
        ...
        function obj = Update(obj, Gyroscope, Accelerometer, Magnetometer,dt)
            %dt added for variable timestep (somewhat variable)
            obj.SamplePeriod = dt;
